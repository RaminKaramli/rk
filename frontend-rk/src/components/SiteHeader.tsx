...
import { aboutMenuLinks, homeMenuLinks, media, overlayMenuImages } from '../data/site'
...
export default function SiteHeader({ isDark, onToggleTheme, page }: SiteHeaderProps) {
  ...
  return (
    <>
      <header
        ref={headerRef}
        className={`site-header${isSectionTwoActive ? ' site-header--section2-left' : ''}${menuOpen ? ' is-open' : ''}`}
        id="siteHeader"
      >
        <div className="header-wrapper">
          <a href="./index.html" className="header-logo" aria-label="Ramin avatar">
      ...
      <div
        ref={menuRef}
        className={`full-width-overlay-menu${isSectionTwoActive ? ' full-width-overlay-menu--side' : ''}${menuOpen ? ' is-open' : ''}`}
        id="fullWidthMenu"
